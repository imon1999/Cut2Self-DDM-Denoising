...
class self2self(nn.Module):
    def __init__(self, in_channel):
        ...
        self.DB1 = DecodeBlock(96, 96, 96)
        self.DB2 = DecodeBlock(144, 96, 96)
        self.DB3 = DecodeBlock(144, 96, 96)
        self.DB4 = DecodeBlock(144, 96, 96)
        self.DB5 = DecodeBlock(96 + in_channel, 64, 32, in_channel, flag=True)
